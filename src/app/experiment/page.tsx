...
export default function Home() {
  return (
    <main>
      <div className="bg-black overflow-hidden flex mx-auto justify-items-center justify-center items-center">
        <svg height="846.4" width="" className="bg-white">
          <svg
            id="FOH"
            height=""
            width=""
          ...
          >
            ...
            <svg id="field_PEND" style={{ cursor: "pointer" }} className="">
              <svg>
                <path
                  fill="#E1DC3C"
              ...
              <svg className="hover:fill-cyan-700">
                <path
                  fill="#E5E13D"
