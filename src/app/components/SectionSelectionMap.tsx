...
const SectionSelectionMap = (props: props) => {
  // const isCategoryMatch = (parentId: string) => {
  //   return props.category === parentId;
  // };

  // const handleClick = (e: React.MouseEvent<SVGElement>) => {
  //   if (isCategoryMatch(e.currentTarget.parentElement?.id || "")) {
  //     props.setSection(e.currentTarget.id);
  //   }
  // };

  const handleChildClick = (e: React.MouseEvent<SVGElement>, parentId: string) => {
  ...
  return (
    <svg height="600" width="1062.3" className="">
      <svg id="FOH">
        ...
        <svg>
          <polygon points="628.4,205.6 709.2,249.4 683.1,267.7 602.3,223.9 		"></polygon>
        </svg>
        <svg>
          <polygon points="683.1,267.7 684.3,275.5 603.5,231.7 602.3,223.9 		"></polygon>
        </svg>
      </svg>
      <svg>
        <svg>
      ...
      <svg id="sections">
        <svg className="" id="4">
          <svg
            id="field_318"
            className={props.category === '4' ? 'hover:brightness-110' : ''}
            onClick={(e) => handleChildClick(e, '4')}
          >
            <svg>
              <polygon
                fill="#acd8a0"
                points="938.6,229.1 965.7,178.8 966.9,187.6 939.9,237.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#acd8a0"
                points="965.5,179.7 966.6,187.5 940.1,237 938.9,229.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#aad39f"
                points="891.8,211.2 890.6,202.7 939.2,229 940.5,237.5 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#aad39f"
                points="938.9,229.2 940.1,237 892.1,211 891,203.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#add9a1"
                points="890.5,203.2 942.4,166.9 965.9,179.6 939,229.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#add9a1"
                points="942.4,167.2 965.5,179.7 938.9,229.2 891,203.2 			"
              ></polygon>
            </svg>
          </svg>
          <svg
          ...
          >
            <svg>
              <polygon
                fill="#add8a1"
                points="883.1,199 935.1,162.6 936.3,171.1 884.4,207.5 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#add8a1"
                points="934.9,163.1 936,171 884.6,207 883.4,199.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#aad39f"
                points="852.3,189.8 851,181.3 883.7,198.9 885,207.5 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#aad39f"
                points="883.4,199.1 884.6,207 852.6,189.6 851.4,181.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#add9a1"
                points="850.9,181.8 902.8,145.5 935.4,163.1 883.4,199.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#add9a1"
                points="902.8,145.8 934.9,163.1 883.4,199.1 851.4,181.8 			"
              ></polygon>
            </svg>
          </svg>
          <svg
          ...
          >
            <svg>
              <polygon
                fill="#add8a1"
                points="844.1,177.9 880.7,152.3 881.9,160.7 845.4,186.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#add8a1"
                points="880.5,152.8 881.6,160.6 845.6,185.8 844.4,178 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#aad39f"
                points="813.1,168.6 811.8,160.1 844.7,177.8 846,186.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#aad39f"
                points="844.4,178 845.6,185.8 813.4,168.4 812.2,160.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#add9a1"
                points="811.7,160.6 848.3,135 881,152.8 844.4,178.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#add9a1"
                points="848.3,135.3 880.5,152.8 844.4,178 812.2,160.6 			"
              ></polygon>
            </svg>
          </svg>
          <svg
          ...
          >
            <svg>
              <polygon
                fill="#add8a1"
                points="763.8,134.4 800.4,108.8 801.6,117.2 765.1,142.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#add8a1"
                points="800.2,109.3 801.3,117.1 765.3,142.3 764.1,134.5 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#aad39f"
                points="732.8,125.1 731.5,116.6 764.4,134.3 765.7,142.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#aad39f"
                points="764.1,134.5 765.3,142.3 733.1,124.9 731.9,117.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#add9a1"
                points="731.4,117.1 768,91.5 800.7,109.3 764.1,134.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#add9a1"
                points="768,91.8 800.2,109.3 764.1,134.5 731.9,117.1 			"
              ></polygon>
            </svg>
          </svg>
          <svg
          ...
          >
            <svg>
              <polygon
                fill="#add8a1"
                points="725.1,113.5 777,77.1 778.3,85.5 726.4,121.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#add8a1"
                points="776.8,77.6 778,85.4 726.6,121.4 725.4,113.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#aad39f"
                points="693.9,104.1 692.6,95.6 725.7,113.4 727,121.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#aad39f"
                points="725.4,113.6 726.6,121.4 694.2,103.9 693,96.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#add9a1"
                points="692.5,96.1 744.5,59.7 777.3,77.6 725.4,113.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#add9a1"
                points="744.5,60 776.8,77.6 725.4,113.6 693,96.1 			"
              ></polygon>
            </svg>
          </svg>
          <svg
          ...
          >
            <svg>
              <polygon
                fill="#add8a1"
                points="686.5,92.6 738.5,56.2 739.7,64.6 687.8,101 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#add8a1"
                points="738.3,56.7 739.4,64.5 688,100.5 686.8,92.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#aad39f"
                points="636.7,73.1 635.4,64.6 687.1,92.5 688.4,101 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#aad39f"
                points="686.8,92.7 688,100.5 637,72.9 635.8,65.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#add9a1"
                points="635,65 714.2,43.3 738.8,56.7 686.8,93 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#add9a1"
                points="635.8,65.1 714.2,43.6 738.3,56.7 686.8,92.7 			"
              ></polygon>
            </svg>
          </svg>
        </svg>
        <svg className="" id="5">
          <svg
            id="field_328"
            className={props.category === '5' ? 'hover:brightness-110' : ''}
            onClick={(e) => handleChildClick(e, '5')}
          >
            <svg>
              <polygon
                fill="#f0c1e9"
                points="327.5,143.8 326.3,135.3 353.9,150.2 355.1,158.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="353.6,150.4 354.7,158.2 327.8,143.6 326.7,135.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="354.4,158.4 353.2,149.9 362.9,155.1 364.2,163.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="362.6,155.3 363.8,163.1 354.7,158.2 353.6,150.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f7c5ef"
                points="362.3,155.2 419.7,115 421,123.4 363.6,163.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f7c5ef"
                points="419.5,115.5 420.7,123.3 363.8,163.1 362.6,155.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f8c5f0"
                points="353.5,150.6 325.9,135.7 396,120.3 419.4,115.2 419.7,115.7 362.6,155.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f8c5f0"
                points="326.7,135.8 396.1,120.6 419.5,115.5 362.6,155.3 353.6,150.4 			"
              ></polygon>
            </svg>
          </svg>
          <svg
          ...
          >
            <svg>
              <polygon
                fill="#f0c1e9"
                points="271.8,164 270.5,155.5 296.7,169.6 298,178.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="296.4,169.8 297.6,177.6 272.1,163.8 270.9,156 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="297.3,177.8 296,169.3 322.4,183.5 323.7,192 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="322.1,183.7 323.3,191.5 297.6,177.6 296.4,169.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f7c5ef"
                points="321.8,183.6 357.4,158.6 358.7,167 323.1,192 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f7c5ef"
                points="357.2,159.1 358.4,166.9 323.3,191.5 322.1,183.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f8c5f0"
                points="296.3,170 270.4,156 286.1,144.9 319.3,138.3 357.7,159.1 322.1,184 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f8c5f0"
                points="286.2,145.2 319.3,138.6 331.5,145.2 357.2,159.1 322.1,183.7 296.4,169.8 270.9,156 			"
              ></polygon>
            </svg>
          </svg>
          <svg
          ...
          >
            <svg>
              <polygon
                fill="#f0c1e9"
                points="233.1,192.4 231.8,183.9 251.4,194.4 252.7,202.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="251.1,194.6 252.3,202.4 233.4,192.2 232.2,184.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="252,202.6 250.7,194.1 269.6,204.2 270.9,212.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="269.3,204.4 270.5,212.3 252.3,202.4 251.1,194.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f7c5ef"
                points="269,204.3 304.9,179.2 306.1,187.6 270.3,212.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f7c5ef"
                points="304.7,179.7 305.8,187.5 270.5,212.3 269.3,204.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f8c5f0"
                points="251,194.8 231.7,184.4 267.6,159.3 286.5,169.6 305.2,179.7 269.3,204.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f8c5f0"
                points="267.6,159.6 286.4,169.8 304.7,179.7 269.3,204.4 251.1,194.6 232.2,184.4 			"
              ></polygon>
            </svg>
          </svg>
          <svg
          ...
          >
            <svg>
              <polygon
                fill="#f0c1e9"
                points="191.5,221.5 190.2,213 209.9,223.6 211.1,232.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="209.6,223.8 210.7,231.6 191.8,221.3 190.6,213.5 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="210.4,231.8 209.2,223.3 228,233.4 229.2,241.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="227.7,233.6 228.8,241.4 210.7,231.6 209.6,223.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f7c5ef"
                points="227.4,233.5 262.7,208.7 264,217.1 228.6,241.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f7c5ef"
                points="262.5,209.2 263.7,217 228.8,241.4 227.7,233.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f8c5f0"
                points="209.5,224 190.1,213.5 225.4,188.8 244.4,199.2 263,209.2 227.7,233.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f8c5f0"
                points="225.4,189.1 244.3,199.4 262.5,209.2 227.7,233.6 209.6,223.8 190.6,213.5 			"
              ></polygon>
            </svg>
          </svg>
          <svg
          ...
          >
            <svg>
              <polygon
                fill="#f0c1e9"
                points="150.9,249.9 149.7,241.4 169.4,252 170.7,260.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="169.1,252.2 170.3,260.1 151.2,249.7 150.1,241.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="170,260.3 168.7,251.7 187.4,261.8 188.7,270.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="187.1,262 188.3,269.8 170.3,260.1 169.1,252.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f7c5ef"
                points="186.8,261.9 220.8,238 222.1,246.5 188.1,270.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f7c5ef"
                points="220.6,238.5 221.8,246.4 188.3,269.8 187.1,262 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f8c5f0"
                points="169,252.4 149.6,241.9 183.5,218.2 202.6,228.6 221.1,238.5 187.1,262.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f8c5f0"
                points="183.5,218.5 202.5,228.8 220.6,238.5 187.1,262 169.1,252.2 150.1,241.9 			"
              ></polygon>
            </svg>
          </svg>
          <svg
          ...
          >
            <svg>
              <polygon
                fill="#f0c1e9"
                points="668.8,528.2 667.5,519.6 675.5,523.9 676.8,532.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="675.2,524.1 676.4,531.9 669.1,528 667.9,520.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="676.1,532.1 674.8,523.6 686.7,529.9 687.9,538.5 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="686.4,530.1 687.5,538 676.4,531.9 675.2,524.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="687.2,538.2 686,529.6 714.1,544.8 715.3,553.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="713.8,545 714.9,552.8 687.5,538 686.4,530.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f7c5ef"
                points="713.5,544.9 747.2,521.2 748.4,529.6 714.7,553.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f7c5ef"
                points="747,521.7 748.1,529.5 714.9,552.8 713.8,545 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
          ...
          >
            <svg>
              <polygon
                fill="#f0c1e9"
                points="709.1,499.9 707.9,491.4 715.9,495.7 717.1,504.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="715.6,495.9 716.7,503.7 709.4,499.7 708.3,491.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="716.4,503.9 715.2,495.4 727,501.7 728.3,510.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="726.7,501.9 727.9,509.7 716.7,503.7 715.6,495.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="727.6,509.9 726.3,501.4 754.4,516.5 755.7,525 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="754.1,516.7 755.3,524.5 727.9,509.7 726.7,501.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f7c5ef"
                points="753.8,516.6 788.3,492.4 789.6,500.8 755.1,525 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f7c5ef"
                points="788.1,492.9 789.3,500.7 755.3,524.5 754.1,516.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f8c5f0"
                points="715.5,496.1 707.8,491.9 742.3,467.8 749.7,471.8 760.8,477.9 788.6,492.9 754.1,517 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
          ...
          >
            <svg>
              <polygon
                fill="#f0c1e9"
                points="749.7,471.5 748.5,463 756.5,467.2 757.8,475.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="756.2,467.4 757.4,475.2 750,471.3 748.9,463.5 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="757.1,475.4 755.8,466.9 767.6,473.3 768.9,481.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="767.3,473.5 768.5,481.3 757.4,475.2 756.2,467.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="768.2,481.5 766.9,473 795,488.1 796.3,496.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="794.7,488.3 795.9,496.1 768.5,481.3 767.3,473.5 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f7c5ef"
                points="794.4,488.2 828.7,464.1 829.9,472.6 795.7,496.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f7c5ef"
                points="828.5,464.6 829.6,472.5 795.9,496.1 794.7,488.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
          ...
          >
            <svg>
              <polygon
                fill="#f0c1e9"
                points="789.3,443.8 788,435.3 807.2,445.6 808.4,454.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="806.9,445.8 808,453.6 789.6,443.6 788.4,435.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f4c3ed"
                points="852.6,456.2 851.4,448.3 855.7,430.7 856.3,430.8 857.5,438.6 853.2,456.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f4c3ed"
                points="856,430.8 857.2,438.6 852.9,456.2 851.7,448.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="807.7,453.8 806.5,445.3 834.6,460.4 835.8,468.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="834.3,460.6 835.4,468.4 808,453.6 806.9,445.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f7c5ef"
                points="834,460.5 851.9,447.8 853.2,456.3 835.2,468.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f7c5ef"
                points="851.7,448.3 852.9,456.2 835.4,468.4 834.3,460.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f8c5f0"
                points="806.8,446 787.9,435.8 821.9,412 840.5,422.1 856.3,430.7 852,448.5 834.3,460.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f8c5f0"
                points="821.9,412.3 840.4,422.3 856,430.8 851.7,448.3 834.3,460.6 806.9,445.8 788.4,435.8 			"
              ></polygon>
            </svg>
          </svg>
          <svg
          ...
          >
            <svg>
              <polygon
                fill="#f4c4ed"
                points="872.8,394.2 871.7,386.3 875.7,374.4 876.3,374.5 877.4,382.3 873.4,394.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f4c4ed"
                points="876,374.5 877.1,382.3 873.1,394.2 872,386.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="828.8,416.1 827.6,407.6 835.6,411.8 836.9,420.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="835.3,412 836.5,419.9 829.1,415.9 828,408.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="836.2,420.1 834.9,411.5 859.3,424.7 860.6,433.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0c1e9"
                points="859,424.9 860.2,432.7 836.5,419.9 835.3,412 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f4c4ed"
                points="859.9,432.7 858.7,424.9 871.7,386.2 872.3,386.3 873.4,394.2 860.5,432.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f4c4ed"
                points="872,386.3 873.1,394.2 860.2,432.7 859,424.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f8c5f0"
                points="835.2,412.2 827.5,408.1 876.5,373.8 872.3,386.4 859.2,425.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f8c5f0"
                points="876,374.5 872,386.3 859,424.9 835.3,412 828,408.1 			"
              ></polygon>
            </svg>
          </svg>
        </svg>
        <svg className="" id="7">
          <svg
            id="field_309"
            className={props.category === '7' ? 'hover:brightness-110' : ''}
            onClick={(e) => handleChildClick(e, '7')}
          >
            <svg>
              <polygon
                fill="#94f0de"
                points="628.4,556.5 627.1,548 646.3,558.2 647.5,566.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#94f0de"
                points="646,558.4 647.1,566.3 628.7,556.3 627.5,548.5 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#95f7e4"
                points="688.1,562.6 706.6,549.6 707.8,558 689.4,571 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#95f7e4"
                points="706.4,550.1 707.5,557.9 689.6,570.5 688.4,562.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#94f0de"
                points="646.8,566.5 645.6,557.9 661.9,566.7 663.2,575.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#94f0de"
                points="661.6,566.9 662.8,574.7 647.1,566.3 646,558.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#94f4e2"
                points="661.3,566.7 688.6,562.4 689.9,570.7 662.6,575 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#94f4e2"
                points="688.4,562.7 689.6,570.5 662.8,574.7 661.6,566.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#95f8e5"
                points="645.9,558.6 627,548.5 660.6,525 679.1,535.1 706.9,550.1 688.5,563 661.5,567.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#95f8e5"
                points="660.6,525.3 679,535.3 706.4,550.1 688.4,562.7 661.6,566.9 646,558.4 627.5,548.5 			"
              ></polygon>
            </svg>
          </svg>
          <svg
          ...
          >
            <svg>
              <polygon
                fill="#94f0de"
                points="121.8,287.2 120.5,278.7 132.1,284.8 133.3,293.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#94f0de"
                points="131.8,285 132.9,292.9 122.1,287 120.9,279.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#94f0de"
                points="132.6,293.1 131.4,284.5 157.8,298.8 159,307.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#94f0de"
                points="157.5,299 158.6,306.8 132.9,292.9 131.8,285 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#95f7e4"
                points="157.2,298.9 196,271.6 197.3,280 158.4,307.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#95f7e4"
                points="195.8,272.1 197,279.9 158.6,306.8 157.5,299 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#95f8e5"
                points="131.7,285.2 120.6,279.4 124.1,258.4 144.6,244.1 170.2,258 196.3,272.1 157.5,299.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#95f8e5"
                points="144.6,244.4 170.1,258.2 195.8,272.1 157.5,299 131.8,285 120.9,279.2 124.4,258.6 			"
              ></polygon>
            </svg>
          </svg>
        </svg>
        <svg className="" id="6">
          <svg
            id="field_209"
            className={props.category === '6' ? 'hover:brightness-110' : ''}
            onClick={(e) => handleChildClick(e, '6')}
          >
            <svg>
              <polygon
                fill="#c4b5f2"
                points="536.1,505.3 534.9,496.7 556.2,508.2 557.5,516.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#c4b5f2"
                points="555.9,508.4 557.1,516.2 536.4,505.1 535.3,497.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#c4b5f2"
                points="556.8,516.4 555.5,507.9 605,534.6 606.3,543.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#c4b5f2"
                points="604.7,534.8 605.9,542.6 557.1,516.2 555.9,508.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#c4b5f2"
                points="605.6,542.8 604.3,534.3 616.3,540.7 617.6,549.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#c4b5f2"
                points="616,540.9 617.2,548.8 605.9,542.6 604.7,534.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#c9b9fa"
                points="615.7,540.8 649.6,517.1 650.9,525.5 617,549.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#c9b9fa"
                points="649.4,517.6 650.6,525.4 617.2,548.8 616,540.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
          ...
          >
            <svg>
              <polygon
                fill="#c4b5f2"
                points="172.5,311 171.3,302.5 184.6,309.6 185.8,318.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#c4b5f2"
                points="184.3,309.8 185.4,317.6 172.8,310.8 171.7,303 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#c4b5f2"
                points="185.1,317.8 183.9,309.3 226.9,332.5 228.1,341 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#c4b5f2"
                points="226.6,332.7 227.7,340.5 185.4,317.6 184.3,309.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#c4b5f2"
                points="227.4,340.7 226.2,332.2 252.5,346.4 253.8,354.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#c4b5f2"
                points="252.2,346.6 253.4,354.4 227.7,340.5 226.6,332.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#c9b9fa"
                points="251.9,346.5 289.8,319.9 291.1,328.3 253.2,354.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#c9b9fa"
                points="289.6,320.4 290.8,328.2 253.4,354.4 252.2,346.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
        ...
        <svg className="" id="3">
          <svg
            id="field_216"
            className={props.category === '3' ? 'hover:brightness-110' : ''}
            onClick={(e) => handleChildClick(e, '3')}
          >
            <svg>
              <polygon
                fill="#eca6a6"
                points="794.7,324.4 793.5,316 847.3,328.8 848.5,337.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#eca6a6"
                points="847,329 848.2,336.8 795,324.2 793.8,316.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
            ...
            <svg>
              <polygon
                fill="#eca6a6"
                points="847.9,337 846.7,328.6 898.8,340.9 900,349.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#eca6a6"
                points="898.5,341.1 899.7,348.9 848.2,336.8 847,329 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0a7a7"
                points="898.2,341.1 917.2,299.9 918.6,308.7 899.6,349.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0a7a7"
                points="917.1,300.9 918.3,308.7 899.7,348.9 898.5,341.1 			"
              ></polygon>
            </svg>
          </svg>
          <svg
          ...
          >
            <svg>
              <polygon
                fill="#efa7a7"
                points="817.4,280.4 833.3,279.1 834.6,287.5 818.7,288.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#efa7a7"
                points="833.1,279.4 834.3,287.2 818.9,288.5 817.7,280.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f3a8a8"
                points="829.6,287.6 832.7,279.7 817.3,281 819.3,275.4 940.5,249.1 919.2,295.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f3a8a8"
                points="819.5,275.6 940,249.5 919,295.6 830,287.4 833.1,279.4 817.7,280.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0a7a7"
                points="918.7,295.6 940.1,248.5 941.5,257.3 920,304.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0a7a7"
                points="940,249.5 941.2,257.3 920.1,303.4 919,295.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#eea6a6"
                points="831,295.5 829.7,287.1 919.2,295.3 920.4,303.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#eea6a6"
                points="919,295.6 920.1,303.4 831.2,295.2 830,287.4 			"
              ></polygon>
            </svg>
          </svg>
          <svg
          ...
          >
            <svg>
              <polygon
                fill="#eba5a5"
                points="529.9,92.1 528.7,84.2 529.3,84.1 552.5,139.8 553.7,147.8 553.1,147.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#eba5a5"
                points="552.2,139.9 553.4,147.8 530.2,92 529,84.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0a7a7"
                points="551.9,139.7 565.1,136.9 566.3,145.2 553.2,148.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0a7a7"
                points="564.9,137.2 566,145 553.4,147.8 552.2,139.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0a7a7"
                points="577.4,151.7 576.3,143.9 599.3,66.7 599.9,66.8 601,74.6 578,151.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0a7a7"
                points="599.6,66.8 600.7,74.6 577.7,151.7 576.6,143.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f3a8a8"
                points="564.7,137.5 552,140.2 528.6,84 600,66.4 576.8,144.1 566.6,146.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f3a8a8"
                points="529,84.2 599.6,66.8 576.6,143.9 566.8,145.9 564.9,137.2 552.2,139.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0a7a7"
                points="566.5,145.7 576.8,143.6 578,151.9 567.8,154 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0a7a7"
                points="576.6,143.9 577.7,151.7 568,153.7 566.8,145.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#eba5a5"
                points="565.7,145.1 564.6,137.2 565.2,137.1 567.1,145.8 568.3,153.7 567.7,153.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#eba5a5"
                points="566.8,145.9 568,153.7 566,145 564.9,137.2 			"
              ></polygon>
            </svg>
          </svg>
          <svg
          ...
          >
            <svg>
              <polygon
                fill="#eba5a5"
                points="458,111 456.7,102.2 478.1,126.5 479.4,135.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#eba5a5"
                points="477.8,126.6 479,134.4 458.3,110.9 457.1,103.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f1a7a7"
                points="519,147.6 543.8,140.4 545,148.9 520.3,156 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f1a7a7"
                points="543.6,140.8 544.7,148.7 520.5,155.6 519.3,147.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f3a8a8"
                points="477.6,126.8 456.6,102.9 521.2,86.3 526,98.2 544,141 519.6,148 523.3,163.5 511.4,165.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
            ...
            <svg>
              <polygon
                fill="#f0a7a7"
                points="511.2,165.1 523.2,163 524.5,171.3 512.4,173.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f0a7a7"
                points="523,163.3 524.2,171.1 512.6,173.1 511.5,165.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#eba5a5"
                points="478.7,134.5 477.4,125.7 511.8,165.2 513,174 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#eba5a5"
                points="511.5,165.3 512.6,173.1 479,134.4 477.8,126.6 			"
              ></polygon>
            </svg>
          </svg>
        </svg>
        <svg className="" id="2">
          <svg
            id="field_224"
            className={props.category === '2' ? 'hover:brightness-110' : ''}
            onClick={(e) => handleChildClick(e, '2')}
          >
            <svg>
              <polygon
                fill="#97d0e9"
          ...
          >
            <svg>
              <polygon
                fill="#97cfe8"
                points="675,147.5 712.3,121.4 713.6,129.8 676.3,155.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="712.1,121.9 713.3,129.7 676.5,155.4 675.3,147.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="658.8,158.9 675.5,147.1 676.8,155.5 660,167.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="675.3,147.6 676.5,155.4 660.2,166.9 659.1,159 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="633.7,176.5 659.3,158.5 660.5,167 634.9,184.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="659.1,159 660.2,166.9 635.1,184.4 634,176.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="602.8,167.3 601.5,158.8 634.3,176.4 635.5,184.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="634,176.6 635.1,184.4 603.1,167.1 601.9,159.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
          ...
          >
            <svg>
              <polygon
                fill="#97cfe8"
                points="713.3,168.3 750.6,142.1 751.8,150.5 714.6,176.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="750.4,142.6 751.5,150.4 714.8,176.2 713.6,168.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="697,179.7 713.8,167.9 715.1,176.3 698.2,188.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="713.6,168.4 714.8,176.2 698.4,187.6 697.3,179.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="671.9,197.2 697.5,179.3 698.7,187.7 673.2,205.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="697.3,179.8 698.4,187.6 673.4,205.2 672.2,197.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="641.2,188.1 640,179.6 672.5,197.1 673.8,205.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="672.2,197.3 673.4,205.2 641.5,187.9 640.4,180.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
          ...
          >
            <svg>
              <polygon
                fill="#97cfe8"
                points="753,189.8 790.3,163.6 791.5,172 754.2,198.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="790.1,164.1 791.2,171.9 754.4,197.7 753.3,189.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="736.6,201.2 753.5,189.4 754.7,197.8 737.9,209.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="753.3,189.9 754.4,197.7 738.1,209.1 736.9,201.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="711.6,218.7 737.1,200.8 738.4,209.2 712.9,227.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="736.9,201.3 738.1,209.1 713.1,226.6 711.9,218.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="680.7,209.5 679.5,201 712.2,218.6 713.5,227.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="711.9,218.8 713.1,226.6 681,209.3 679.9,201.5 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
          ...
          >
            <svg>
              <polygon
                fill="#97cfe8"
                points="792.8,211.3 830.1,185.2 831.4,193.6 794.1,219.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="829.9,185.7 831.1,193.5 794.3,219.3 793.1,211.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="776.4,222.8 793.3,210.9 794.6,219.4 777.7,231.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="793.1,211.4 794.3,219.3 777.9,230.8 776.7,222.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="751.5,240.3 776.9,222.4 778.2,230.9 752.7,248.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="776.7,222.9 777.9,230.8 752.9,248.2 751.8,240.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="720.7,231.2 719.5,222.6 752.1,240.2 753.3,248.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="751.8,240.4 752.9,248.2 721,231 719.9,223.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
          ...
          >
            <svg>
              <polygon
                fill="#97cfe8"
                points="831.5,232.3 868.7,206.1 870,214.5 832.7,240.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="868.5,206.6 869.7,214.4 832.9,240.2 831.8,232.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="831.2,232.3 832,232 833.2,240.4 832.5,240.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="831.8,232.4 832.9,240.2 832.7,240.3 831.5,232.5 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="815,243.8 831.7,232 833,240.4 816.2,252.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="831.5,232.5 832.7,240.3 816.4,251.7 815.3,243.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="790.1,261.2 815.5,243.4 816.7,251.8 791.4,269.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="815.3,243.9 816.4,251.7 791.6,269.1 790.4,261.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="759.6,252.2 758.3,243.7 790.7,261.1 792,269.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="790.4,261.3 791.6,269.1 759.9,252 758.7,244.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
          ...
          >
            <svg>
              <polygon
                fill="#97cee6"
                points="876.4,252.6 922.4,240.5 923.6,248.9 877.6,261 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cee6"
                points="922.2,240.9 923.3,248.7 877.8,260.6 876.7,252.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cee6"
                points="871.1,254 876.9,252.4 878.1,260.8 872.4,262.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cee6"
                points="876.7,252.8 877.8,260.6 872.6,262 871.4,254.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cee6"
                points="807.6,270.6 871.6,253.8 872.9,262.2 808.9,279 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cee6"
                points="871.4,254.2 872.6,262 809.1,278.6 807.9,270.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="798.7,273.4 797.4,264.9 808.2,270.6 809.5,279.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="807.9,270.8 809.1,278.6 799,273.2 797.8,265.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
          ...
          >
            <svg>
              <polygon
                fill="#96cae2"
                points="815.6,358.9 814.4,350.4 845.1,367 846.4,375.5 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="844.8,367.2 846,375 815.9,358.7 814.8,350.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="845.7,375.2 844.4,366.7 856.2,373 857.4,381.5 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="855.9,373.2 857,381 846,375 844.8,367.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97d0e9"
                points="844.7,367.4 814.7,351.1 774.6,329.4 788.6,319.7 840.1,332.9 894,346.9 855.9,373.5 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
            ...
            <svg>
              <polygon
                fill="#97cfe8"
                points="855.6,373.1 893.5,346.5 894.7,354.9 856.8,381.5 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="893.3,347 894.4,354.8 857,381 855.9,373.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="776,337.5 774.7,328.9 815.1,350.7 816.3,359.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
          ...
          >
            <svg>
              <polygon
                fill="#96cae2"
                points="736.9,364.7 735.6,356.2 757.4,367.9 758.7,376.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="757.1,368.1 758.3,375.9 737.2,364.5 736,356.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="758,376.1 756.7,367.6 805.9,394.2 807.2,402.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="805.6,394.4 806.8,402.2 758.3,375.9 757.1,368.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="806.5,402.4 805.2,393.9 817.1,400.2 818.3,408.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="816.8,400.4 817.9,408.2 806.8,402.2 805.6,394.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="816.5,400.3 850.9,376.1 852.2,384.5 817.7,408.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="850.7,376.6 851.9,384.4 817.9,408.2 816.8,400.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97d0e9"
                points="805.5,394.6 757,368.3 735.5,356.7 770,332.6 791.2,344.2 851.2,376.6 816.8,400.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
          ...
          >
            <svg>
              <polygon
                fill="#96cae2"
                points="696,393.3 694.8,384.8 716.5,396.4 717.7,405 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="716.2,396.6 717.3,404.5 696.3,393.1 695.2,385.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="717,404.7 715.8,396.1 765.1,422.7 766.3,431.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="764.8,422.9 765.9,430.8 717.3,404.5 716.2,396.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="765.6,431 764.4,422.4 776.2,428.8 777.5,437.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="775.9,429 777.1,436.8 765.9,430.8 764.8,422.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="775.6,428.9 809.8,404.9 811.1,413.3 776.9,437.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="809.6,405.4 810.8,413.2 777.1,436.8 775.9,429 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
          ...
          >
            <svg>
              <polygon
                fill="#96cae2"
                points="656.3,421.1 655,412.6 676.6,424.2 677.9,432.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="676.3,424.4 677.5,432.3 656.6,420.9 655.4,413.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="677.2,432.5 675.9,423.9 680.1,426.1 681.4,434.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="679.8,426.3 681,434.2 677.5,432.3 676.3,424.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="680.7,434.4 679.4,425.8 710.2,442.4 711.4,450.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="709.9,442.6 711,450.4 681,434.2 679.8,426.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="710.7,450.6 709.5,442.1 725.2,450.6 726.5,459.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="724.9,450.8 726.1,458.6 711,450.4 709.9,442.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="725.8,458.8 724.5,450.3 736.4,456.6 737.7,465.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="736.1,456.8 737.3,464.7 726.1,458.6 724.9,450.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="735.8,456.7 770.3,432.6 771.5,441 737.1,465.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="770.1,433.1 771.2,440.9 737.3,464.7 736.1,456.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
          ...
          >
            <svg>
              <polygon
                fill="#96cae2"
                points="615.6,449.8 614.3,441.3 635.8,452.9 637.1,461.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="635.5,453.1 636.7,460.9 615.9,449.6 614.7,441.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="636.4,461.1 635.1,452.6 639.4,454.8 640.7,463.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="639.1,455 640.3,462.8 636.7,460.9 635.5,453.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="640,463 638.7,454.5 669.4,471 670.7,479.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="669.1,471.2 670.3,479.1 640.3,462.8 639.1,455 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="670,479.3 668.7,470.7 684.4,479.1 685.6,487.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="684.1,479.3 685.2,487.2 670.3,479.1 669.1,471.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="684.9,487.4 683.7,478.8 695.6,485.2 696.9,493.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="695.3,485.4 696.5,493.2 685.2,487.2 684.1,479.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="695,485.3 729.7,461 731,469.4 696.3,493.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="729.5,461.5 730.7,469.3 696.5,493.2 695.3,485.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
          ...
          >
            <svg>
              <polygon
                fill="#96cae2"
                points="574.9,478.1 573.6,469.6 595,481.1 596.3,489.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="594.7,481.3 595.9,489.2 575.2,477.9 574,470.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="595.6,489.4 594.3,480.8 599,483.3 600.2,491.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="598.7,483.5 599.8,491.3 595.9,489.2 594.7,481.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="599.5,491.5 598.3,483 628.9,499.5 630.2,508 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="628.6,499.7 629.8,507.5 599.8,491.3 598.7,483.5 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="629.5,507.7 628.2,499.2 643.7,507.5 645,516 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="643.4,507.7 644.6,515.5 629.8,507.5 628.6,499.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="644.3,515.7 643,507.2 655,513.6 656.3,522.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="654.7,513.8 655.9,521.7 644.6,515.5 643.4,507.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="654.4,513.7 688.3,489.9 689.6,498.4 655.7,522.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="688.1,490.4 689.3,498.3 655.9,521.7 654.7,513.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
          ...
          >
            <svg>
              <polygon
                fill="#96cae2"
                points="232.6,268.3 231.3,259.8 244.8,267.1 246.1,275.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="244.5,267.3 245.7,275.1 232.9,268.1 231.7,260.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="245.4,275.3 244.1,266.8 260.4,275.5 261.7,284.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="260.1,275.7 261.3,283.6 245.7,275.1 244.5,267.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="261,283.8 259.7,275.2 284.8,288.8 286.1,297.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="284.5,289 285.7,296.8 261.3,283.6 260.1,275.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="285.4,297 284.1,288.5 287.4,290.2 288.6,298.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="287.1,290.4 288.2,298.2 285.7,296.8 284.5,289 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="287.9,298.4 286.7,289.9 312.7,303.9 314,312.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="312.4,304.1 313.6,311.9 288.2,298.2 287.1,290.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="312.1,304 387.7,250.7 389,259.2 313.4,312.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="387.5,251.2 388.7,259.1 313.6,311.9 312.4,304.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
          ...
          >
            <svg>
              <polygon
                fill="#96cae2"
                points="213.6,282.6 212.3,274 225.2,280.9 226.5,289.5 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="224.9,281.1 226.1,289 213.9,282.4 212.7,274.5 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="225.8,289.2 224.5,280.6 240.8,289.4 242.1,297.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="240.5,289.6 241.7,297.4 226.1,289 224.9,281.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="241.4,297.6 240.1,289.1 265.4,302.6 266.6,311.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="265.1,302.8 266.2,310.6 241.7,297.4 240.5,289.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="265.9,310.8 264.7,302.3 267.9,304 269.1,312.5 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="267.6,304.2 268.7,312 266.2,310.6 265.1,302.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="268.4,312.2 267.2,303.7 293.1,317.6 294.4,326.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#96cae2"
                points="292.8,317.8 294,325.6 268.7,312 267.6,304.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="292.5,317.7 309.9,305.9 311.1,314.3 293.8,326.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#97cfe8"
                points="309.7,306.4 310.8,314.2 294,325.6 292.8,317.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
        ...
        <svg className="" id="1">
          <svg
            id="field_PENB"
            className={props.category === '1' ? 'hover:brightness-110' : ''}
            onClick={(e) => handleChildClick(e, '1')}
          >
            <svg>
              <polygon
                fill="#edeb9c"
                points="450.2,333.2 451.5,308.7 452.1,308.7 453.2,316.6 452,341 451.4,341 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#edeb9c"
                points="451.8,308.7 452.9,316.6 451.7,341 450.5,333.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#edeb9c"
                points="449.8,341.4 450.2,333.2 450.8,333.2 452,341 451.6,349.2 451,349.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#edeb9c"
                points="450.5,333.2 451.7,341 451.3,349.2 450.1,341.4 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#edeb9c"
                points="449.4,348 449.8,341.4 450.4,341.4 451.6,349.2 451.2,355.8 450.6,355.8 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#edeb9c"
                points="450.1,341.4 451.3,349.2 450.9,355.8 449.7,348 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#eae89c"
                points="355.9,304.8 354.7,296.2 450,347.8 451.3,356.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#eae89c"
                points="449.7,348 450.9,355.8 356.2,304.6 355.1,296.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
        ...
        <svg className="" id="10">
          ...
          >
            <svg>
              <polygon
                fill="#ebc390"
                points="449.4,348.3 449.4,348 450,348 451.2,355.8 451.2,356.1 450.6,356.1 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#ebc390"
                points="449.7,348 450.9,355.8 450.9,356.1 449.7,348.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#eec590"
                points="442.8,352.8 449.9,347.8 451.2,356.2 444.1,361.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#eec590"
                points="449.7,348.3 450.9,356.1 444.3,360.7 443.1,352.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#eec590"
                points="440,354.8 443.3,352.4 444.6,360.8 441.3,363.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#eec590"
                points="443.1,352.9 444.3,360.7 441.5,362.7 440.3,354.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#eec590"
                points="434.8,358.5 440.5,354.4 441.8,362.8 436,366.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#eec590"
                points="440.3,354.9 441.5,362.7 436.2,366.4 435.1,358.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#e8c18f"
                points="341,315.2 339.8,306.7 435.4,358.4 436.6,366.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#e8c18f"
                points="435.1,358.6 436.2,366.4 341.3,315 340.2,307.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
        ...
        <svg className="" id="9">
          ...
          >
            <svg>
              <polygon
                fill="#c3e3f1"
                points="429.4,362.2 435.3,358.1 436.5,366.5 430.6,370.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#c3e3f1"
                points="435.1,358.6 436.2,366.4 430.8,370.1 429.7,362.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#c3e3f1"
                points="425.3,365.1 429.9,361.8 431.1,370.2 426.5,373.5 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#c3e3f1"
                points="429.7,362.3 430.8,370.1 426.7,373 425.6,365.2 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#c3e3f1"
                points="423.1,366.6 425.8,364.7 427,373.1 424.4,375 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#c3e3f1"
                points="425.6,365.2 426.7,373 424.6,374.5 423.4,366.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#bfddea"
                points="325.7,325.9 324.5,317.4 419.9,369.2 421.2,377.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#bfddea"
                points="419.6,369.4 420.8,377.2 326,325.7 324.9,317.9 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
            ...
            <svg>
              <polygon
                fill="#c3e3f1"
                points="419.3,369.3 423.6,366.2 424.9,374.6 420.6,377.7 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
        ...
        <svg className="" id="8">
          ...
          >
            <svg>
              <polygon
                fill="#f37ffa"
                points="405.5,378.9 419.8,368.9 421.1,377.3 406.8,387.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f37ffa"
                points="419.6,369.4 420.8,377.2 407,386.8 405.8,379 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f47ffb"
                points="310.4,327.6 324.9,317.6 420.1,369.4 405.8,379.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#f47ffb"
                points="324.9,317.9 419.6,369.4 405.8,379 310.9,327.6 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
                fill="#ec7ff2"
                points="311.8,335.7 310.5,327.1 406.1,378.8 407.4,387.3 			"
              ></polygon>
            </svg>
            <svg>
              <polygon
        ...
        <svg>
          <polygon points="637.8,482.4 644.9,486.3 644.1,486.9 638,483.6 637.6,485.2 636.5,485.1 637.1,482.9 		"></polygon>
        </svg>
        <svg>
          <path
        ...
        <svg>
          ...
          <svg>
            <polygon points="680.2,452.7 687.3,456.6 686.4,457.2 680.3,453.9 680,455.5 678.9,455.5 679.4,453.2 			"></polygon>
          </svg>
          <svg>
            <path
        ...
        <svg>
          <polygon points="719.7,425.1 726.8,428.9 725.9,429.5 719.9,426.2 719.5,427.9 718.4,427.8 719,425.6 		"></polygon>
        </svg>
        <svg>
          <path
        ...
        <svg>
          ...
          <svg>
            <polygon points="799.4,369.3 806.5,373.1 805.6,373.8 799.5,370.5 799.2,372.1 798.1,372 798.6,369.8 			"></polygon>
          </svg>
          <svg>
            <path
        ...
        <svg>
          <polygon points="835.4,344 842.5,347.9 841.7,348.5 835.6,345.2 835.2,346.8 834.1,346.8 834.7,344.6 		"></polygon>
        </svg>
        <svg>
          <path
        ...
        <svg>
          ...
          <svg>
            <polygon points="861.3,313.6 868.5,317.5 867.6,318.1 861.5,314.8 861.1,316.4 860,316.4 860.6,314.1 			"></polygon>
          </svg>
          <svg>
            <path
        ...
        <svg>
          ...
          <svg>
            <polygon points="858.6,239.4 865.8,243.3 864.9,243.9 858.8,240.6 858.4,242.2 857.3,242.2 857.9,240 			"></polygon>
          </svg>
          <svg>
            <path
        ...
        <svg>
          <polygon points="826.6,217.5 833.8,221.4 832.9,222 826.8,218.7 826.4,220.3 825.3,220.2 825.9,218 		"></polygon>
        </svg>
        <svg>
          <path
        ...
        <svg>
          <polygon points="469,135.9 469.6,136.2 473.4,141.8 472.3,142.4 468.8,137 465.3,139.5 464.5,139.1 		"></polygon>
        </svg>
        <svg>
          <path
        ...
        <svg>
          <polygon points="708.1,520.6 715.2,524.5 714.3,525.1 708.2,521.8 707.9,523.4 706.8,523.4 707.3,521.2 		"></polygon>
        </svg>
        <svg>
          <path
        ...
        <svg>
          <polygon points="750.5,492.4 757.6,496.3 756.8,496.9 750.7,493.6 750.3,495.2 749.2,495.1 749.8,492.9 		"></polygon>
        </svg>
        <svg>
          <polygon points="754.5,489.7 761.6,493.5 760.7,494.1 754.6,490.9 754.3,492.4 753.2,492.4 753.7,490.2 		"></polygon>
        </svg>
        <svg>
          <path
        ...
        <svg>
          ...
          <svg>
            <polygon points="789.6,465.1 796.7,468.9 795.8,469.6 789.7,466.3 789.3,467.9 788.3,467.8 788.8,465.6 			"></polygon>
          </svg>
          <svg>
            <path
        ...
        <svg>
          <polygon points="828.4,437.9 835.5,441.7 834.6,442.4 828.6,439.1 828.2,440.7 827.1,440.6 827.7,438.4 		"></polygon>
        </svg>
        <svg>
          <path
        ...
        <svg>
          <polygon points="894.5,271 895.1,271.3 898.9,277 897.8,277.5 894.3,272.1 890.8,274.6 890,274.2 		"></polygon>
        </svg>
        <svg>
          <path
        ...
        <svg>
          <polygon points="888.7,275 895.9,278.9 895,279.5 888.9,276.2 888.5,277.8 887.4,277.8 888,275.5 		"></polygon>
        </svg>
        <svg>
          <path
        ...
        <svg>
          <polygon points="925.6,196.7 932.8,200.6 931.9,201.3 925.8,197.9 925.4,199.6 924.3,199.5 924.9,197.3 		"></polygon>
        </svg>
        <svg>
          <path
        ...
        <svg>
          <polygon points="884.7,173.9 891.9,177.8 891,178.5 884.9,175.1 884.5,176.7 883.4,176.7 884,174.4 		"></polygon>
        </svg>
        <svg>
          <path
        ...
        <svg>
          ...
          <svg>
            <polygon points="850.3,405 857.4,408.9 856.5,409.5 850.5,406.2 850.1,407.8 849,407.8 849.6,405.6 			"></polygon>
          </svg>
          <svg>
            <path
        ...
        <svg>
          <polygon points="521.2,419.7 522.2,420.3 519.5,422.2 527.4,426.5 526.3,427.2 518.4,423 515.7,424.9 514.7,424.3 		"></polygon>
        </svg>
        <svg>
          <path
        ...
        <svg>
          <polygon points="551.4,398.6 560.3,403.4 559.2,404.2 550.3,399.4 		"></polygon>
        </svg>
        <svg>
          <path
        ...
        <svg>
          <polygon points="362.2,330.6 363.2,331.2 360.5,333.1 368.4,337.4 367.3,338.1 359.4,333.9 356.6,335.7 355.7,335.2 		"></polygon>
        </svg>
        <svg>
          <path
        ...
        <svg>
          <polygon points="392.4,309.5 401.3,314.3 400.2,315.1 391.3,310.3 		"></polygon>
        </svg>
        <svg>
          <path
        ...
        <svg>
          <polygon points="489.6,244.7 490.6,245.2 487.9,247.1 495.8,251.4 494.7,252.2 486.8,247.9 484,249.8 483.1,249.3 		"></polygon>
        </svg>
        <svg>
          <path
        ...
        <svg>
          <polygon points="640.5,327 641.4,327.5 638.7,329.4 646.6,333.7 645.5,334.5 637.6,330.2 634.9,332.1 633.9,331.5 		"></polygon>
        </svg>
        <svg>
          <polygon
        ...
        <svg>
          <polygon points="670.6,305.8 679.5,310.6 678.4,311.4 669.5,306.6 		"></polygon>
        </svg>
        <svg>
          <path
        ...
        <svg>
          <polygon points="749.6,169 756.8,172.9 755.9,173.5 749.8,170.2 749.4,171.8 748.3,171.8 748.9,169.5 		"></polygon>
        </svg>
        <svg>
          <path
      ...
      <svg>
        <svg>
          <svg>
            <polygon
              fill="#211D1E"
              points="547,312.2 548.1,320.1 468.7,326.9 467.5,319 			"
            ></polygon>
          </svg>
          <svg>
            <polygon
              fill="#201D1E"
              points="467.5,319 468.7,326.9 468.1,365 466.9,357.2 			"
            ></polygon>
          </svg>
          <svg>
            <polygon
              fill="#221E1F"
              points="288.2,356.5 289.3,364.3 215.5,416 214.3,408.2 			"
            ></polygon>
          </svg>
          <svg>
            <polygon
              fill="#ECECEC"
              points="547,312.2 548.1,320.1 547.3,369.4 546.2,361.6 			"
            ></polygon>
          </svg>
          <svg>
            <polygon
              fill="#EFEFEF"
              points="546.2,361.6 547.3,369.4 485.6,374.7 484.4,366.9 			"
            ></polygon>
          </svg>
          <svg>
            <polygon
              fill="#201D1E"
              points="548,311.5 549.1,319.4 548.3,370 547.1,362.2 			"
            ></polygon>
          </svg>
          <svg>
            <polygon
              fill="#211D1E"
              points="547.1,362.2 548.3,370 486,375.3 484.8,367.5 			"
            ></polygon>
          </svg>
          <svg>
            <polygon
              fill="#221E1F"
              points="466.9,357.2 468.1,365 390.7,419.2 389.5,411.4 			"
            ></polygon>
          </svg>
          <svg>
            <polygon
              fill="#201C1D"
              points="389.5,411.4 390.7,419.2 289.3,364.3 288.2,356.5 			"
            ></polygon>
          </svg>
          <svg>
            <polygon
              fill="#F5F5F5"
              points="484.4,366.9 485.6,374.7 408.4,428.8 407.2,421 			"
            ></polygon>
          </svg>
          <svg>
            <polygon
              fill="#221E1F"
              points="484.8,367.5 486,375.3 409.8,428.7 408.6,420.8 			"
            ></polygon>
          </svg>
          <svg>
            <polygon
              fill="#201C1D"
              points="508,475.6 509.2,483.4 408.4,428.8 407.2,421 			"
            ></polygon>
          </svg>
          <svg>
            <polygon
              fill="#F5F5F5"
              points="508,475.6 509.2,483.4 435.3,535.1 434.2,527.3 			"
            ></polygon>
          </svg>
          <svg>
            <polygon
              fill="#E6E6E6"
              points="434.2,527.3 435.3,535.1 215.5,416 214.4,408.2 			"
            ></polygon>
          </svg>
          <svg>
            <path
          ...
          <svg>
            <polygon
              fill="#221E1F"
              points="509.4,475.4 510.6,483.3 435.3,535.9 434.2,528.1 			"
            ></polygon>
          </svg>
          <svg>
            <polygon
              fill="#201C1D"
              points="434.2,528.1 435.3,535.9 214.1,416.2 212.9,408.3 			"
            ></polygon>
          </svg>
        </svg>
      </svg>
      <svg>
        ...
        <svg>
          <polygon points="344.9,422.2 359.2,430 357,431.5 351,428.3 333.1,440.8 330.7,439.5 348.6,427 342.7,423.8 		"></polygon>
        </svg>
      </svg>
    </svg>
  );
...
export default SectionSelectionMap;
